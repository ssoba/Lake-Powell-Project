...
![**Figure 8.** Slopes from each linear trendline of each order of zooplankton are displayed relative to each other. Red bars indicate months with statistically significant change (p < 0.05).](Zoop_slope.png)
