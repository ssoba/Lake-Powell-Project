...
![**Figure 3.** Metalimnion average monthly temperature from 1992-2015. The metalimnion was defined as 39-41m depth. A linear trendline and R-squared value is displayed for each month. Solid trend lines indicate a statistically significant (p < 0.05) change in temperature over the 23-year period.](/Users/sarasoba/Desktop/lake_powell/figures/Meta_temp.png)
...
![**Figure 4.** Hypolimnion average monthly temperature from 1992-2015. The hypolimnion was defined as 99-105m depth. A linear trendline and R-squared value is displayed for each month. Solid trend lines indicate a statistically significant (p < 0.05) change in temperature over the 23-year period.](/Users/sarasoba/Desktop/lake_powell/figures/hypo_temp.png)
